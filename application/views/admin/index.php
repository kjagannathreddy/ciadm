...
<!-- Echart js -->
<script src="<?php echo base_url();?>admin/plugins/charts/echarts/js/echarts-all.js"></script>

<script type="text/javascript" src="<?php echo base_url();?>admin/pages/dashboard.js"></script>
            ...
            <div class="row">
                <div class="col-xl-3">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-sm-6">
                            <div class="card">
                                <div class="bg-warning dashboard-resource">
                                    <div class="card-block">
                                        <h5 class="counter">20.85</h5>%
                                        <h5 class="resource-used">Resource Used</h5>
                                    </div>
                ...
                <div class="col-xl-9 grid-item">
                    <div class="card">
                        <div class="row">
                            <div class="col-lg-7 txt-white climacon-left">
                                <div class="card-block bg-primary">
                                    ...
                                    <div>
                                        <h6 class="cloud-date d-inline">Yesterday, 12th October 2015</h6>
                        ...
                        <div class="card-block">
                            <div class="table-responsive">
                                <table class="table m-b-0 photo-table">
                                    ...
                                    <tr>
                                        <th>
                                            <img class="img-fluid rounded-circle" src="<?php echo base_url();?>admin/images/avatar-2.png" alt="User">
                                        </th>
                                        <td>Appestia Project
                                    ...
                                    <tr>
                                        <th>
                                            <img class="img-fluid rounded-circle" src="<?php echo base_url();?>admin/images/avatar-4.png" alt="User">
                                        </th>
                                    ...
                                    <tr>
                                        <th>
                                            <img class="img-fluid rounded-circle" src="<?php echo base_url();?>admin/images/avatar-1.png" alt="User">
                                        </th>
                                    ...
                                    <tr>
                                        <th>
                                            <img class="img-fluid rounded-circle" src="<?php echo base_url();?>admin/images/avatar-3.png" alt="User">
                                        </th>
                                        <td class="chart">Contract with belife Company
                                            <p><i class="icofont icofont-clock-time"></i>Created 20.10.2016</p>
                                        </td>
                                        <td>
                                            <span class="pie" style="display: none;">0.52/1.561</span><svg class="peity" height="30" width="30"><path d="M 15.000000000000002 0 A 15 15 0 0 1 28.00043211809656 22.482564048691025 L 15 15" fill="#2196F3"></path><path d="M 28.00043211809656 22.482564048691025 A 15 15 0 1 1 14.999999999999996 0 L 15 15" fill="#ccc"></path></svg>
                ...
                <div class="col-xl-4 col-lg-12">
                    <div class="card">
                        <div class="user-block-2">
                            <img class="img-fluid" src="<?php echo base_url();?>admin/images/widget/user-1.png" alt="user-header">
